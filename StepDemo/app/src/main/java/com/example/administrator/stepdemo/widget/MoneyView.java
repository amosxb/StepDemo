package com.example.administrator.stepdemo.widget;
 ...
 *
 * @author xb
 * @time 2018/11/15 0015 10:08
 */
public class MoneyView extends View {
    private boolean mIsGroupingUsed; //是否开启 千分符
    private boolean mIsUserPrefix; //是否使用前缀
    private boolean mIsUserBold; //是否设置粗体字
    ...
    private int mPointPaddingRight = dp2px(8); //小数点与分的间隔
    /**
     * 绘制时控制文本绘制的范围
     */
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIsUserPrefix = typedArray.getBoolean(R.styleable.MoneyView_isUserPrefix, false);
        mIsUserBold = typedArray.getBoolean(R.styleable.MoneyView_isUserBold, false);
        typedArray.recycle();
     ...
     * 是否设置前缀
     */
    public void setIsUserPrefix(boolean used) {
        this.mIsUserPrefix = used;
    }

    /**
     * 是否设置粗体
     */
    public void setIsUserBold(boolean used) {
        this.mIsUserBold = used;
    }
